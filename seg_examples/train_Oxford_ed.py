...
from segmentationCRF.models import UNet, EncoderDecoder
...
python seg_examples/train_Oxford_ed.py -d /global/cfs/cdirs/m636/geshi/data/ -e /global/cfs/cdirs/m636/geshi/exp/Oxford/trajectory/ed/CrossEntropy -n 0 -a encoderdecoder -l ce -s 3376 -p 1 -g 0 -f 1 -ne 30 -ln 0.0 -lr 0.001 -bs 32 -ad 5 -aw 16 -ip 224 -t --benchmark --verbose
"""
...
if args.architecture == 'encoderdecoder':
