...
#SBATCH -o logs/non_crf_percentages.%N.%j.out # STDOUT
#SBATCH -e logs/non_crf_percentages.%N.%j.err # STDERR
...
for percentage in "${percentages[@]} "; do
    ...
    _train_cmd="python -u /global/u2/g/geshi/loss-landscapes-segmentation/seg_examples/train_Oxford_crfseg.py \
        ...
        -e /global/cfs/cdirs/m636/geshi/exp/Oxford/percentage/CrossEntropy/non-crf/seed_$seed \
        -n 0_p_${percentage/"."/""}\
        -a unet \
        -l ce \
        -s $seed \
