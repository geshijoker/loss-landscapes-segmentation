...
#SBATCH -o logs/non_crf_batch_sizes.%N.%j.out # STDOUT
#SBATCH -e logs/non_crf_batch_sizes.%N.%j.err # STDERR
...
for batchsize in "${batchsizes[@]} "; do
    ...
    _train_cmd="python -u /global/u2/g/geshi/loss-landscapes-segmentation/seg_examples/train_Oxford_crfseg.py \
        ...
        -e /global/cfs/cdirs/m636/geshi/exp/Oxford/batch_size/CrossEntropy/non-crf/seed_$seed \
        -n 0_bs_$batchsize\
        -a unet \
        -l ce \
        -s $seed \
