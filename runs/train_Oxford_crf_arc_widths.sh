...
#SBATCH -o logs/crf_arc_widths.%N.%j.out # STDOUT
#SBATCH -e logs/crf_arc_widths.%N.%j.err # STDERR
...
for arcwidth in "${arcwidths[@]} "; do
    ...
    _train_cmd="python -u /global/u2/g/geshi/loss-landscapes-segmentation/seg_examples/train_Oxford_crfseg.py \
        ...
        -e /global/cfs/cdirs/m636/geshi/exp/Oxford/arc_widths/CrossEntropy/crf/seed_$seed \
        -n 0_aw_${arcwidth}\
        -a unet-crf \
        -l ce \
        -s $seed \
