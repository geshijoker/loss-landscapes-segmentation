...
#SBATCH -o logs/non_crf_seeds.%N.%j.out # STDOUT
#SBATCH -e logs/non_crf_seeds.%N.%j.err # STDERR
...
for seed in "${seeds[@]} "; do
    ...
    _train_cmd="python -u /global/u2/g/geshi/loss-landscapes-segmentation/seg_examples/train_Oxford_crfseg.py \
        ...
        -e /global/cfs/cdirs/m636/geshi/exp/Oxford/seeds/CrossEntropy/non-crf/seed_$seed \
        -n optimal \
        -a unet \
        -l ce \
        -s $seed \
