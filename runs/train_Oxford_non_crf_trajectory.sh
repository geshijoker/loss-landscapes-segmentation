...
#SBATCH -o logs/non_crf_seeds_8049.%N.%j.out # STDOUT
#SBATCH -e logs/non_crf_seeds_8049.%N.%j.err # STDERR
...
for lr in "${learning_rates[@]} "; do
    ...
    _train_cmd="python -u /global/u2/g/geshi/loss-landscapes-segmentation/seg_examples/train_Oxford_crfseg.py \
        ...
        -e /global/cfs/cdirs/m636/geshi/exp/Oxford/trajectory/non-crf/CrossEntropy/0_seed_$seed \
        -n 0_lr_${lr/"."/""} \
        -a unet \
        -l ce \
        -s $seed \
