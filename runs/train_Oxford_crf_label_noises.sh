...
#SBATCH -o logs/crf_label_noises.%N.%j.out # STDOUT
#SBATCH -e logs/crf_label_noises.%N.%j.err # STDERR
...
for labelnoise in "${label_noises[@]} "; do
    ...
    _train_cmd="python -u /global/u2/g/geshi/loss-landscapes-segmentation/seg_examples/train_Oxford_crfseg.py \
        ...
        -e /global/cfs/cdirs/m636/geshi/exp/Oxford/label_noises/CrossEntropy/crf/seed_$seed \
        -n 0_ln_${labelnoise/"."/""} \
        -a unet-crf \
        -l ce \
        -s $seed \
