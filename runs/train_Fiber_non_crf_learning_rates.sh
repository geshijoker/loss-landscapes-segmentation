...
#SBATCH -o logs/learning_rates.%N.%j.out # STDOUT
#SBATCH -e logs/learning_rates.%N.%j.err # STDERR
...
for lr in "${learning_rates[@]} "; do
    ...
    _train_cmd="python -u /global/u2/g/geshi/loss-landscapes-segmentation/seg_examples/train_Fiber_crfseg.py \
        ...
        -e /global/cfs/cdirs/m636/geshi/exp/Fiber/learning_rate/CrossEntropy/non-crf/seed_$seed \
        -n 0_lr_${lr/"."/""}\
        -a unet \
        -l ce \
        -s $seed \
